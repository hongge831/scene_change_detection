...
caffe_model=root + 'model_saved/SiameseNet__iter_50000.caffemodel'   #训练好的 caffemodel
...
videoCapture = cv2.VideoCapture('D:\VOC_HY\VIDEO/11.24_rotation/12011.mp4')
...
# 读帧
frameNum = 1
firstFrame = np.zeros((1,10))
secondFrame = np.zeros((1,10))
